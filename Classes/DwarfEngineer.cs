...
namespace WarcraftPlugin.Classes
{
    ...
    internal class PickAxeEffect(CCSPlayerController owner, float duration, bool success, Vector trace) : WarcraftEffect(owner, duration, onTickInterval: 1f)
    {
        ...
        public override void OnStart()
        {
            ...
            if (success)
            {
                var grenadeName = MineDrops[RandomProvider.Next(MineDrops.Length)];
                ...
                weaponDrop.SetColor(DropColors[RandomProvider.Next(DropColors.Count)]);
            ...
            else
            {
                ...
                _junkProp.SetScale(RandomProvider.NextFloat() * 0.3f + 0.2f);
    ...
    internal class BuildEffect(CCSPlayerController owner) : WarcraftEffect(owner, onTickInterval: 0.01f)
    {
        ...
        public override void OnStart()
        {
            ...
            WarcraftPlugin.Instance.DebugSetModel("[DwarfEngineer] BlueprintInit", _blueprintProp, currentDef.ModelPath);
        ...
        public override void OnTick()
        {
            ...
            ulong buttonState = movement.Buttons.ButtonStates[0];
