...
namespace WarcraftPlugin.Helpers
{
    public static class Geometry
    {
        ...
        {
            double x = (2 * RandomProvider.NextDouble() - 1) * box.Extent.x;
            double y = (2 * RandomProvider.NextDouble() - 1) * box.Extent.y;
            double z = (2 * RandomProvider.NextDouble() - 1) * box.Extent.z;
